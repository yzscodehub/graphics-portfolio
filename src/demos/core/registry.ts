...
export const demoRegistry: Record<string, DemoLoader> = {
  "material-lighting": {
    definition: {
      ...
      relatedArticles: ["rhi-abstraction-boundaries", "material-lighting-color-pipeline"],
  ...
  "shadow-aa": {
    definition: {
      ...
      relatedProjects: ["real-time-rendering-lab"],
      relatedArticles: ["rhi-abstraction-boundaries", "shadow-temporal-aa"],
  ...
  "frame-inspector": {
    definition: {
      ...
      relatedProjects: ["engine-systems-explorer"],
      relatedArticles: ["render-graph-lifetime", "frame-inspector-observability"],
